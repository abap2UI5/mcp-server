...
export const TOOLS = [
  ...
  },
  {
    ...
    description:
      ...
      'A failed download is reported, never silently turned into a full build. Stops a running backend first. Only one build runs at a time: a second call with the ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        mode: { type: 'string', enum: ['auto', 'incremental', 'prebuilt', 'full'], description: 'default auto' },
      },
    },
  },
  {
