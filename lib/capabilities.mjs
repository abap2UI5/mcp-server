...
function capabilitiesFile() {
  ...
  if (!demokit) throw new Error('samples-controls checkout not found — set AI_DEMOKIT_HOME or clone it as a sibling (the capability map lives there)');
  return path.join(demokit, 'CAPABILITIES.md');
}
